...
<div class="modal-footer">
    <p class="fieldset">
        ...
        <button class="btn btn-blue btn-effect m" data-dismiss="modal" type="submit" value="Create account" style="background-color: dodgerblue; margin-right: 5px" >Cancel</button>
    </p>
